    ...
    PROJECT_DATA = {
        ...
        "turing_ontology": {
            "cluster": [
                "deuxième_dossier",
                "mutation_example.py",
                "node_mutation_all_python_file.py",
                "node_mutation_javascript_file.py",
                "node_mutation_python_file.py",
                "node_mutation_typescript_file.py",
                "premier_dossier"
            ],
            "clusters_detailed": [
                {
                    "name": "deuxième_dossier",
                    "id": "79330f68-2d22-4470-b775-c5673335448c",
                    "root_labels": []
                },
                {
                    "name": "mutation_example.py",
                    "id": "8e7c904a-2448-4b6f-9dcf-26337f891f74",
                    "root_labels": []
                },
                {
                    "name": "node_mutation_all_python_file.py",
                    "id": "4b4041e7-d55f-4af8-bc75-cf3afe1cc0ea",
                    "root_labels": []
                },
                {
                    "name": "node_mutation_javascript_file.py",
                    "id": "d720bf2d-62da-43cf-93b3-5e179e4291be",
                    "root_labels": []
                },
                {
                    "name": "node_mutation_python_file.py",
                    "id": "fcb95921-5793-455e-8e01-2445d336c1be",
                    "root_labels": []
                },
                {
                    "name": "node_mutation_typescript_file.py",
                    "id": "24e0df3e-874b-4868-98ae-53516b8b52b0",
                    "root_labels": []
                },
                {
                    "name": "premier_dossier",
                    "id": "93ec615f-2924-4b14-8a45-58438ba6dc0a",
                    "root_labels": [
                        {
                            "name": "AWS_architecture.png",
                            "id": "373ca873-e962-415a-bf67-dc57e594b56a",
                        ...
                        },
                        {
                            ...
                            "id": "54d61e2c-b66d-4a44-9de8-971480a8f2f7",
                        ...
                        {
                            "name": "hello_world.js",
                            "id": "eea51d7e-1eca-4661-b9d2-5c9d8b989f85",
                        ...
                        {
                            "name": "moduleA.py",
                            "id": "959b1dca-7fd0-4a59-9fe3-40f02dd6bcc1",
                            "full_path": "C:/Users/Ditrakely/Desktop/kakarote\\premier_dossier\\moduleA.py",
                            "type": "file",
                            "category": [],
                            "parent_labels": [],
                            "child_labels": []
                        ...
                        {
                            "name": "moduleB.py",
                            "id": "114d84ea-e5ea-40fe-8734-478cfed77e0e",
                            "full_path": "C:/Users/Ditrakely/Desktop/kakarote\\premier_dossier\\moduleB.py",
                            "type": "file",
                            "category": [],
                            "parent_labels": [],
                            "child_labels": []
                        },
                        {
                            ...
                            "parent_labels": [
                                ...
                                {
                                    "name": "test.py",
                                    "id": "6b07c572-7e65-47e8-89e3-23ac69d5d409",
                        ...
                        },
                        {
                            ...
                            "id": "d762bff6-95ed-4f53-878b-665b836b78da",
                        ...
                        {
                            "name": "typescript.ts",
                            "id": "cb8f92b3-2f9f-4d66-ae1c-e5ba0e6838c1",
