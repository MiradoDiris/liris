...
from ui.widgets.tabs.submit_button_widget import SubmitButtonWidget
...
class PlatformConfigWidget(QtWidgets.QWidget):
    ...
    def _init_ui(self):
        ...
        help_steps = QtWidgets.QLabel(
            ...
            "4. Configurez le bouton de soumission<br>"
        ...
        # Onglet 4: Bouton de soumission
        self.submit_button_widget = SubmitButtonWidget(self.config_provider, self.conductor)
        self.submit_button_widget.submit_button_configured.connect(self._on_submit_button_configured)
        self.submit_button_widget.submit_button_detected.connect(self._on_submit_button_detected)
        self.tabs.addTab(self.submit_button_widget, "Bouton de soumission")
    ...
    def _on_submit_button_configured(self, platform_name, config):
        """Gère l'événement de configuration du bouton de soumission"""
        print(f"DEBUG: Configuration du bouton de soumission pour '{platform_name}' mise à jour")
        self._update_tab_status()
    ...
    def _update_tab_status(self):
        ...
        config_states = {
            ...
            3: 'submit_button' in interface_positions,  # Bouton configuré?
        ...
        base_titles = ["Configuration Générale", "Gestion des navigateurs",
                       "Champ de prompt", "Bouton de soumission", "Zone de réponse"]
    ...
    def _load_profiles_from_files(self):
        ...
        try:
            ...
            # Mettre à jour le widget du bouton de soumission avec les profils
            if hasattr(self, 'submit_button_widget'):
                self.submit_button_widget.set_profiles(self.profiles)
    ...
    def _on_platform_selected(self, current, previous):
        ...
        try:
            ...
            # Sélectionner cette plateforme dans le widget de bouton de soumission
            if hasattr(self, 'submit_button_widget'):
                self.submit_button_widget.select_platform(platform_name)
    ...
    def _on_delete_platform(self):
        ...
        try:
            ...
            # Mettre à jour le widget du bouton de soumission
            if hasattr(self, 'submit_button_widget'):
                self.submit_button_widget.set_profiles(self.profiles)
    ...
    def refresh(self):
        ...
        # Actualiser le widget du bouton de soumission
        if hasattr(self, 'submit_button_widget'):
            self.submit_button_widget.refresh()
