"""
Script de connexion et interaction automatique avec Gemini
"""
...
def interact_with_gemini(message):
    """Interagit automatiquement avec Gemini"""
    ...
    print("\n2️⃣  Navigation vers Gemini")
    client.navigate("https://gemini.google.com/")
    print("✅ Page Gemini chargée")
    time.sleep(3)
    ...
    if isinstance(elements, list):
        for elem in elements:
            ...
            if not input_field:
                ...
                elif "prompt" in elem_aria or "search" in elem_aria:
                    input_field = elem
...
if __name__ == "__main__":
    MESSAGE = "Quelle est la différence entre l'IA et le machine learning?"
    
    client = interact_with_gemini(MESSAGE)